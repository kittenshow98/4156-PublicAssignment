...
public class GameTest {
  ...
  */
  ...
  public void startNewGame() {
    ...
    kong.unirest.HttpResponse<String> response = Unirest.get("http://localhost:8080/").asString();
  ...
  */
  ...
  public void newGameTest() {
    ...
    kong.unirest.HttpResponse<String> response = Unirest.get("http://localhost:8080/newgame").asString();
    int restStatus = response.getStatus();
  ...
  */
  ...
  public void startGameTest() {
    ...
    kong.unirest.HttpResponse<String> response = Unirest.post("http://localhost:8080/startgame").body("type=X").asString();
